...
print(get_missing_number([3, 4, -1, 1]))
print(get_missing_number([1, 2, 0]))
print(get_missing_number([1, 2, 5]))
print(get_missing_number([1]))
print(get_missing_number([-1, -2]))
